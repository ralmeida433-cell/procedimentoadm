...
_PADROES_POSTO = [
    ...
    (re.compile(r"1[º°o.\s]*ten|1[º°o.\s]*tenente", re.IGNORECASE), "1º Tenente"),
    (re.compile(r"2[º°o.\s]*ten|2[º°o.\s]*tenente", re.IGNORECASE), "2º Tenente"),
    ...
    (re.compile(r"1[º°o.\s]*sgt|1[º°o.\s]*sargento", re.IGNORECASE), "1º Sargento"),
    (re.compile(r"2[º°o.\s]*sgt|2[º°o.\s]*sargento", re.IGNORECASE), "2º Sargento"),
    (re.compile(r"3[º°o.\s]*sgt|3[º°o.\s]*sargento", re.IGNORECASE), "3º Sargento"),
